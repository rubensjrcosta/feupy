...
#         table["e2dnde_err"] = d["sed_e2dnde_err"]
        ...
        # Set descriptions and format for columns
...
class SourceCatalogObjectExtraHAWC(SourceCatalogObject):
    ...
    def flux_points(self):
        """Flux points as a `~gammapy.estimators.FluxPoints` object."""
        file_path = ""
        filename = f"$PYTHONPATH/data/dedicated_publications/hawc/2021ApJ...907L..30A/{name_to_fname(self.name)}.fits"
