...
def read_pulsar_catalog(filename="$PYTHONPATH/data/catalogs/pulsar_spectra/2022PASA...39...56S/pulsar_spectra.yaml"):
    """
    ...
    try:
        ...
        print(f"YAML loading error: {error}")
        return {}
...
def create_flux_points_table(pulsar_jname):
    ...
    try:
        ...
        print(f"Error: Pulsar J-name '{pulsar_jname}' not found in the catalog.")
